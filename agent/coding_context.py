...
CODING_AGENT_GUIDANCE = (
    ...
    "- Before you finish a round of edits, re-read your own diff and tidy it: "
    "drop stray debug output and leftover scaffolding, and keep the change "
...
def _coding_instructions(config: Optional[dict[str, Any]]) -> str:
    ...
    always run /clean before committing") without editing the shipped brief.
